...
class ChoosePlotType extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
			variables: props.variables,  chosen: 'hist'
        };
        ...
        return (
			<section id="choose-plot-container">
				...
				<section id='variable-picker'>
					<CreatePlotForm variables={this.state.variables} 
						plot_name={this.state.chosen} var_names={var_names[this.state.chosen]} key={this.state.chosen} 
...
class SubjectPlotter extends React.Component {
    constructor(props) {
        ...
        ReactDOM.render(<SubjectImages key='hover'
